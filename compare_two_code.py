...
if __name__ == '__main__':
    ...
    parser.add_argument('-i_1', '--input_1', type=str, default='test_data/test_11.cpp', help='path to directory')
    parser.add_argument('-i_2', '--input_2', type=str, default='test_data/test_2.cpp', help='path to directory')
